...
var deviceMotion_1 = require("./deviceMotion");
var FULLTILT = /** @class */ (function () {
    function FULLTILT() {
    }
    FULLTILT.getDeviceOrientation = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sensor = new deviceOrientation_1.DeviceOrientation(options);
                        sensor.start();
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, utils_1.sensorCheck(sensor)];
                    case 2:
                        _a.sent();
    ...
    FULLTILT.getDeviceMotion = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sensor = new deviceMotion_1.DeviceMotion();
                        sensor.start();
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
